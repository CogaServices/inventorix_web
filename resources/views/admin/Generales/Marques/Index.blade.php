...
<div class="row">
  ...
  <div class="table-responsive">
                    ...
                    <div class="row align-items-end">
                        ...
                        </div><a class="button is-info" href="{{ route('marque.create') }}">Créer un  marque</a>
                        </div>
                    </div>
                        ...
                        <tbody>
                            @foreach($marques as $marque)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('marque.show', $marque->ID_marque) }}">
                                            <i class="icon feather icon-eye f-w-600 f-16 m-r-15 text-c-green"></i>
                                        </a>
                                        <a href="{{ route('marque.edit',$marque->ID_marque) }}">
                                            <i class="feather icon-edit f-w-600 f-16 text-c-red"></i>
                                        </a>
                                        <form action="{{ route('marque.destroy', $marque->ID_marque) }}" method="post">
                                            @csrf
                                            @method('DELETE')
                                            <button  type="submit">
